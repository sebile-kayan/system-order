...
const MainTabNavigator = () => {
  ...
  const getTabScreens = () => {
    ...
    if (currentRole === "admin") {
      ...
      // Menu, Table Management ve Employees - tab'da görünmez, sadece hızlı işlemlerde erişilebilir
      // Bu ekranlar artık tab'da değil, sadece navigation stack'te mevcut
